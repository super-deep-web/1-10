...
const SlidingPuzzle = ({ level, size = 3, onComplete, puzzleImage }) => {
  ...
  return (
    <div className="flex flex-col items-center px-4 max-w-full w-full">
      ...
      {/* Botón para omitir el puzzle (solo para pruebas) */}
      {/* <button
        onClick={() => onComplete && onComplete(level)}
        className="text-xs bg-gray-200 text-gray-500 px-2 py-1 rounded mb-2 hover:bg-gray-300"
